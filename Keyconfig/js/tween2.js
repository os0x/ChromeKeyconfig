...
function Tween(item, opt) {
  ...
  var L = sets.length, delay = opt.delay*1000 || 0, startTime = Date.now() + delay, run = function(){
    var now = Date.now(), tim = self.prev = now - startTime;
    for (var k = 0; k < L; ++k) {
